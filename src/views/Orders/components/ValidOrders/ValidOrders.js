...
class ValidOrders extends Component {
  ...
  nbLensesCount = () => {
    ...
    axios.get('https://mocbackend.cleverapps.io/ordersLentille/countLensesOrdersByStatus/' + userId.id + '/' + "Validated")
  ...
  nbProductCount = () => {
    ...
    axios.get('https://mocbackend.cleverapps.io/ordersProduit/countProductOrdersByStatus/' + userId.id + '/' + "Validated")
