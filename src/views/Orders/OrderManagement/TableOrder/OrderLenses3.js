       ...
       this.qte=0
        ...
        this.state.rowData.forEach(order => {
            ...
            if (order.Quantite > 0 ) {
                ...
                this.setState({ message: "information Submited successfully with status Draft available Quantity is "+this.state.AQOfLenses })
            ...
            <div className="table">
                ...
                <div className="table-body">
                    {this.state.rowData.map((index) =>
                        ...
                        <div className="table-row" >
                        <div className="table-data">
                        <label style={{ color: 'red' }}>Total Quantity : </label>    {this.state.totalQuantity}
                        </div>
